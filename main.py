...
player2 = Person("Robin:", 4160, 188, 311, 34, player_spells, player_items)
player3 = Person("Robot:", 3089, 174, 288, 34, player_spells, player_items)
enemy = Person("Magus", 12200, 701, 525, 25, [], [])
...
while running:
    ...
    if enemy.get_hp() == 0:
        ...
        print(bcolors.FAIL + "You loose! Your enemy has defeated you" + bcolors.ENDC)
        running = False
